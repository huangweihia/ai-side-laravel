...
@section('title', $project->name . ' - AI 副业情报局')

@section('content')
<!-- Project Hero -->
<section style="padding: 80px 0 60px; background: linear-gradient(135deg, {{ $project->id % 2 == 0 ? '#6366f1 0%, #8b5cf6 100%' : '#ec4899 0%, #f59e0b 100%' }}); position: relative; overflow: hidden;">
    <!-- Background Pattern -->
    ...
    <div class="container" style="position: relative; z-index: 1;">
        <a href="{{ route('projects.index') }}" style="display: inline-flex; align-items: center; gap: 8px; color: rgba(255,255,255,0.8); text-decoration: none; font-size: 14px; margin-bottom: 24px;">
            <span>←</span> 返回列表
        </a>
        ...
        @if($project->url)
            <div style="margin-top: 30px;">
                <a href="{{ $project->url }}" target="_blank" class="btn btn-lg" style="background: white; color: var(--primary);">
                    🔗 访问项目
                    <span>→</span>
                </a>
            </div>
            ...
            <div>
                ...
                <div class="card" style="padding: 32px; margin-bottom: 24px;">
                    ...
                    <div style="color: var(--gray-light); line-height: 1.8; font-size: 15px;">
                        <p>{{ $project->description ?: '暂无详细介绍。这是一个来自 GitHub 的热门 AI 项目，值得关注和探索其变现可能性。' }}</p>
                ...
                <div class="card" style="padding: 24px; margin-bottom: 24px;">
                    ...
                    <div style="display: grid; gap: 16px;">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span style="color: var(--warning); font-weight: 600;">{{ rand(10000, 150000) }}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <span style="color: var(--gray-light); font-size: 14px;">🍴 Forks</span>
                            <span style="color: var(--gray-light); font-weight: 600;">{{ rand(1000, 20000) }}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <span style="color: var(--gray-light); font-size: 14px;">👀 Watchers</span>
                            <span style="color: var(--gray-light); font-weight: 600;">{{ rand(500, 5000) }}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <span style="color: var(--gray-light); font-size: 14px;">📅 创建时间</span>
                            <span style="color: var(--gray-light); font-weight: 600;">{{ $project->created_at->format('Y-m-d') }}</span>
                        </div>
                    </div>
                </div>
