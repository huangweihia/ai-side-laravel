<?php $__env->startSection('title', '文章列表 - AI 副业情报局'); ?>
    ...
    <div class="container">
        <div>
            ...
            <div style="display: flex; gap: 12px; flex-wrap: wrap; margin-bottom: 24px;">
                <a href="<?php echo e(route('articles.index', request()->only(['search', 'sort']))); ?>" style="padding: 10px 20px; background: <?php echo e(!request('category') ? 'var(--primary)' : 'rgba(255,255,255,0.05)'); ?>; color: <?php echo e(!request('category') ? 'white' : 'var(--gray-light)'); ?>; border-radius: 12px; font-size: 14px; font-weight: 600; text-decoration: none;">📝 全部</a>
                <a href="<?php echo e(request()->fullUrlWithQuery(['category' => 'ai-tools'])); ?>" style="padding: 10px 20px; background: <?php echo e(request('category') === 'ai-tools' ? 'var(--primary)' : 'rgba(255,255,255,0.05)'); ?>; color: <?php echo e(request('category') === 'ai-tools' ? 'white' : 'var(--gray-light)'); ?>; border-radius: 12px; font-size: 14px; font-weight: 600; text-decoration: none;">🤖 AI 工具</a>
                <a href="<?php echo e(request()->fullUrlWithQuery(['category' => 'side-projects'])); ?>" style="padding: 10px 20px; background: <?php echo e(request('category') === 'side-projects' ? 'var(--primary)' : 'rgba(255,255,255,0.05)'); ?>; color: <?php echo e(request('category') === 'side-projects' ? 'white' : 'var(--gray-light)'); ?>; border-radius: 12px; font-size: 14px; font-weight: 600; text-decoration: none;">💡 副业</a>
                <a href="<?php echo e(request()->fullUrlWithQuery(['category' => 'learning'])); ?>" style="padding: 10px 20px; background: <?php echo e(request('category') === 'learning' ? 'var(--primary)' : 'rgba(255,255,255,0.05)'); ?>; color: <?php echo e(request('category') === 'learning' ? 'white' : 'var(--gray-light)'); ?>; border-radius: 12px; font-size: 14px; font-weight: 600; text-decoration: none;">📖 教程</a>
                <a href="<?php echo e(request()->fullUrlWithQuery(['category' => 'monetization'])); ?>" style="padding: 10px 20px; background: <?php echo e(request('category') === 'monetization' ? 'var(--primary)' : 'rgba(255,255,255,0.05)'); ?>; color: <?php echo e(request('category') === 'monetization' ? 'white' : 'var(--gray-light)'); ?>; border-radius: 12px; font-size: 14px; font-weight: 600; text-decoration: none;">💰 变现</a>
                <a href="<?php echo e(request()->fullUrlWithQuery(['category' => 'news'])); ?>" style="padding: 10px 20px; background: <?php echo e(request('category') === 'news' ? 'var(--primary)' : 'rgba(255,255,255,0.05)'); ?>; color: <?php echo e(request('category') === 'news' ? 'white' : 'var(--gray-light)'); ?>; border-radius: 12px; font-size: 14px; font-weight: 600; text-decoration: none;">📰 资讯</a>
            </div>
            ...
            <!-- 次行：统计 + 最新/最热 -->
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px; flex-wrap: wrap; gap: 16px;">
                    <div style="color: var(--gray-light); font-size: 14px;">
                        共 <span style="color: var(--primary-light); font-weight: 600;"><?php echo e($articles->total()); ?></span> 篇文章
                    </div>
                    <div style="display: flex; gap: 12px;">
                        <a href="<?php echo e(request()->fullUrlWithQuery(['sort' => 'latest'])); ?>" style="padding: 8px 16px; background: <?php echo e(request('sort') !== 'popular' ? 'var(--primary)' : 'rgba(255,255,255,0.05)'); ?>; color: <?php echo e(request('sort') !== 'popular' ? 'white' : 'var(--gray-light)'); ?>; border: <?php echo e(request('sort') !== 'popular' ? 'none' : '1px solid rgba(255,255,255,0.1)'); ?>; border-radius: 8px; font-size: 13px; cursor: pointer; text-decoration: none;">📅 最新</a>
            ...
            <!-- 文章列表 -->
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($articles->hasPages()): ?>
                    <div style="display: flex; justify-content: center; margin-top: 60px; gap: 8px;">
                        <?php echo e($articles->links('pagination::simple-bootstrap-4')); ?>
