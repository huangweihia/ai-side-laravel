    ...
    <div class="container">
        ...
        <div class="hero-cta">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->guest()): ?>
                ...
                <a href="<?php echo e(route('login')); ?>" class="btn btn-secondary btn-lg">
                    已有账号？登录
                </a>
            <?php else: ?>
...
<section style="padding: 100px 0;">
    <div class="container">
        <div class="card" style="background: var(--gradient-primary); padding: 60px 40px; text-align: center; border: none;">
            ...
            <?php else: ?>
                <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-lg" style="background: white; color: var(--primary);">
                    进入个人中心
                    <span>→</span>
                </a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
