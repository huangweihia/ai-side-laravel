...
<div class="container" style="max-width: 700px; margin: 60px auto;">
    <div class="card" style="padding: 40px;">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
            <div style="margin-bottom: 20px; padding: 12px 16px; border-radius: 12px; background: rgba(16,185,129,0.15); color: #6ee7b7;"><?php echo e(session('success')); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <form id="subscription-preferences-form" method="POST" action="<?php echo e(route('subscriptions.update')); ?>">
            <?php echo csrf_field(); ?>
