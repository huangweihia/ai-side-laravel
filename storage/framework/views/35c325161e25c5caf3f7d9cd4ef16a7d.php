<?php $__env->startSection('title', $job->title . ' - ' . $job->company_name); ?>
    ...
    <div style="display: grid; grid-template-columns: 1fr 350px; gap: 40px;">
        ...
        <div>
            ...
            <div style="background: var(--dark-light); border-radius: 16px; padding: 32px; margin-bottom: 24px; border: 1px solid rgba(255,255,255,0.08);">
                    ...
                    <div style="flex: 1;">
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 12px; color: var(--gray-light); font-size: 14px;">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->salary_range): ?>
                                <span>·</span>
                                <span style="color: #10b981;">💰 <?php echo e($job->salary_range); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <span>·</span>
                            <span>👁️ <?php echo e($job->view_count); ?> 次浏览</span>
                            <span>·</span>
                            <span>📩 <?php echo e($job->apply_count); ?> 次申请</span>
                        </div>
                    </div>
                    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->is_contact_vip && !$canViewContact): ?>
                        <a href="<?php echo e(route('vip', ['redirect' => route('jobs.show', $job)])); ?>" style="display: block; padding: 12px 20px; background: linear-gradient(135deg, rgba(251, 191, 36, 0.15), rgba(245, 158, 11, 0.15)); border: 1px solid rgba(251, 191, 36, 0.3); border-radius: 12px; text-align: center; text-decoration: none;">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->description): ?>
                    <div style="margin-bottom: 24px;">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$job->is_vip_only || $canViewFullContent): ?>
                            <div class="job-html-content" style="color: var(--gray-light); line-height: 1.85;"><?php echo $job->description; ?></div>
                        <?php else: ?>
                            <p style="color: var(--gray-light); line-height: 1.8;"><?php echo e(\Illuminate\Support\Str::limit(strip_tags($job->description), 320)); ?></p>
                            <div style="margin-top: 16px; padding: 20px; border-radius: 12px; border: 1px solid rgba(251, 191, 36, 0.35); background: rgba(251, 191, 36, 0.08); text-align: center;">
                                ...
                                <a href="<?php echo e(route('vip', ['redirect' => request()->fullUrl()])); ?>" style="display: inline-block; padding: 10px 22px; background: linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%); color: #0f172a; border-radius: 10px; font-weight: 700; text-decoration: none;">开通 VIP 查看完整描述</a>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->requirements): ?>
                    <div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$job->is_vip_only || $canViewFullContent): ?>
                            <div style="color: var(--gray-light); line-height: 1.8; white-space: pre-wrap;"><?php echo e($job->requirements); ?></div>
                        <?php else: ?>
                            <p style="color: var(--gray-light); line-height: 1.8;"><?php echo e(\Illuminate\Support\Str::limit($job->requirements, 200)); ?></p>
            ...
            <div style="background: var(--dark-light); border-radius: 16px; padding: 32px; margin-bottom: 24px; border: 1px solid rgba(255,255,255,0.08);">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canViewContact): ?>
                    <div style="display: grid; gap: 16px;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->contact_email): ?>
                            <div style="display: flex; align-items: center; gap: 12px; padding: 16px; background: rgba(99, 102, 241, 0.1); border-radius: 12px; border: 1px solid rgba(99, 102, 241, 0.2);">
                                ...
                                <div>
                                    ...
                                    <div style="font-size: 16px; color: var(--white); font-weight: 600;"><?php echo e($job->contact_email); ?></div>
                                </div>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->contact_phone): ?>
                            <div style="display: flex; align-items: center; gap: 12px; padding: 16px; background: rgba(16, 185, 129, 0.1); border-radius: 12px; border: 1px solid rgba(16, 185, 129, 0.2);">
                                ...
                                <div>
                                    ...
                                    <div style="font-size: 16px; color: var(--white); font-weight: 600;"><?php echo e($job->contact_phone); ?></div>
                                </div>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->contact_wechat): ?>
                            <div style="display: flex; align-items: center; gap: 12px; padding: 16px; background: rgba(34, 197, 94, 0.1); border-radius: 12px; border: 1px solid rgba(34, 197, 94, 0.2);">
                                ...
                                <div>
                                    ...
                                    <div style="font-size: 16px; color: var(--white); font-weight: 600;"><?php echo e($job->contact_wechat); ?></div>
                                </div>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$job->contact_email && !$job->contact_phone && !$job->contact_wechat): ?>
                ...
                <?php else: ?>
                    <div style="text-align: center; padding: 40px;">
                        ...
                        <a href="<?php echo e(route('vip', ['redirect' => route('jobs.show', $job)])); ?>" 
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                <div style="background: var(--dark-light); border-radius: 16px; padding: 32px; margin-bottom: 24px; border: 1px solid rgba(255,255,255,0.08);">
                    ...
                    <button onclick="applyJob(<?php echo e($job->id); ?>)" 
            ...
            <div style="margin-top: 40px;">
                <h2 style="font-size: 20px; font-weight: 700; color: #1e293b; margin: 0 0 24px;">
                    💬 评论 (<span id="comment-count"><?php echo e($commentsTotal); ?></span>)
                </h2>
                            ...
                            <div style="display: flex; gap: 16px; align-items: flex-start;">
                                ...
                                <div style="flex: 1; min-width: 0;">
                                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                                        <div>
                                            <a href="<?php echo e(route('users.show', $comment->user_id)); ?>" style="color: #1e293b; font-weight: 600; font-size: 15px; text-decoration: none;"><?php echo e($comment->user->name ?? '匿名用户'); ?></a>
                                        ...
                                        <div style="display: flex; gap: 8px; align-items:center;">
                                            <button type="button"
                                                ...
                                                👍 <?php echo e($comment->like_count ?? 0); ?>
        ...
        <div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($relatedJobs->count()): ?>
                <div style="background: var(--dark-light); border-radius: 16px; padding: 20px; margin-bottom: 24px; border: 1px solid rgba(255,255,255,0.08);">
                    ...
                    <div style="display: grid; gap: 12px;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $relatedJobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('jobs.show', $related)); ?>" 
                               ...
                               onmouseout="this.style.borderColor='transparent'; this.style.background='rgba(99, 102, 241, 0.1)'; this.style.transform='translateX(0)'">
                                ...
                                <div style="font-size: 12px; color: var(--gray-light);">
                                    <?php echo e($related->company_name); ?> · <?php echo e($related->location ?: '地点不限'); ?>
...
function submitComment() {
    ...
    fetch(`/jobs/<?php echo e($job->id); ?>/comments`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/jobs/show.blade.php ENDPATH**/ ?>