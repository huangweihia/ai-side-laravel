                    ...
                    <div style="position: relative; min-height: 68vh; border-radius: 20px; overflow: hidden; border: 2px solid rgba(251, 191, 36, 0.5); background: linear-gradient(180deg, rgba(15, 23, 42, 0.95) 0%, rgba(15, 23, 42, 0.88) 100%); box-shadow: inset 0 0 120px rgba(0,0,0,0.45);">
                        ...
                        <div style="position: relative; z-index: 1; padding: 48px 28px 40px; text-align: center; max-width: 560px; margin: 0 auto;">
                            ...
                            <p style="color: #cbd5e1; font-size: 15px; line-height: 1.85; margin: 0 0 28px;">
                                <?php echo e($article->summary ?? '本文为 VIP 专属内容，开通会员后可阅读全文。'); ?>

                            </p>
                            <a href="<?php echo e(route('vip', ['redirect' => request()->fullUrl()])); ?>" style="padding: 14px 32px; border-radius: 14px; background: linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%); color: #fff; font-weight: 800; font-size: 16px; text-decoration: none; display: inline-block; box-shadow: 0 12px 40px rgba(245, 158, 11, 0.35);">
                                开通 VIP 阅读全文
                            </a>
                        </div>
                                ...
                                <div style="flex: 1; min-width: 0;">
                                    <div class="comment-item-head" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                                        ...
                                        <div style="display: flex; gap: 8px; align-items:center;">
                                            ...
                                            <button type="button"
                                                onclick="startArticleReply(<?php echo e($comment->id); ?>, '<?php echo e(addslashes($comment->user->name ?? '匿名用户')); ?>')"
                                        ...
                                        <div class="replies-container" data-comment-id="<?php echo e($comment->id); ?>" style="margin-top: 16px; padding-left: 24px; border-left: 2px solid #dbeafe;">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $comment->replies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ridx => $reply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="reply-item" style="padding: 12px 0; border-bottom: 1px solid #e2e8f0; <?php echo e(!$isReplyVisible ? 'display:none;' : ''); ?>; word-wrap: break-word; word-break: break-word; overflow-wrap: break-word;">
                                                    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 8px; gap:8px;">
                                                        ...
                                                        <button type="button"
                                                            onclick="startArticleReply(<?php echo e($comment->id); ?>, '<?php echo e(addslashes($reply->user->name ?? '匿名用户')); ?>', <?php echo e($reply->id); ?>)"
                                                            style="border: 1px solid #e2e8f0; background: #fff; border-radius: 999px; padding: 4px 10px; color: #667eea; cursor: pointer; font-size: 12px; font-weight: 600; transition: all 0.2s; "
                                                            class="reply-btn"
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($shouldCollapseReplies): ?>
                                                <div style="padding: 8px 0;">
                                                    <button type="button" onclick="toggleArticleRepliesExpand('<?php echo e($comment->id); ?>', <?php echo e($replyCount); ?>)"
                ...
                <div class="site-ad-sidebar-card">
                    ...
                    <div class="site-ad-sidebar-body">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($adSlot->display_mode === 'html' && filled($adSlot->html_content)): ?>
                            <div class="site-ad-sidebar-html"><?php echo $adSlot->html_content; ?></div>
                        <?php else: ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($adResolvedImg): ?>
                                <div class="site-ad-sidebar-img">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($adSlot->link_url): ?>
                                        <a href="<?php echo e($adSlot->link_url); ?>" target="_blank" rel="noopener noreferrer">
                                            <img src="<?php echo e($adResolvedImg); ?>" alt="">
                                        </a>
                                    <?php else: ?>
                                        <img src="<?php echo e($adResolvedImg); ?>" alt="">
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($adSlot->title)): ?>
                                <h3 class="site-ad-sidebar-title"><?php echo e($adSlot->title); ?></h3>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($adSlot->body)): ?>
                                <div class="site-ad-sidebar-text"><?php echo nl2br(e($adSlot->body)); ?></div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($adSlot->cta_label) && filled($adSlot->link_url)): ?>
                                <a href="<?php echo e($adSlot->link_url); ?>" class="site-ad-sidebar-cta" target="_blank" rel="noopener noreferrer"><?php echo e($adSlot->cta_label); ?> <span aria-hidden="true">›</span></a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
...
function submitArticleComment() {
    ...
    fetch('<?php echo e(route("articles.comments.store", $article->id)); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
