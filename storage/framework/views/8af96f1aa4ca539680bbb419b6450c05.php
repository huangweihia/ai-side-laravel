...
<body class="<?php echo \Illuminate\Support\Arr::toCssClasses(['has-site-marquee' => isset($marqueeAnnouncements) && $marqueeAnnouncements->isNotEmpty()]); ?>">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($marqueeAnnouncements) && $marqueeAnnouncements->isNotEmpty()): ?>
        <?php
        ...
        <div id="site-marquee-bar" class="site-marquee-bar" role="region" aria-label="站点公告">
            <a href="<?php echo e(route('announcements.show', $marqueeFirst->slug)); ?>" class="site-marquee-link">
                <div class="site-marquee-viewport">
                    <span class="site-marquee-track"><?php echo e($marqueeDup); ?></span>
                </div>
            </a>
    ...
    ?>
    <main class="main">
        <div class="layout-page-grid<?php echo e($showAdSidebar ? ' layout-with-sidebar' : ''); ?>">
            <div class="layout-page-primary">
                <?php echo $__env->yieldContent('content'); ?>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showAdSidebar): ?>
