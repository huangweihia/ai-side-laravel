<?php $__env->startSection('title', '浏览历史 - AI 副业情报局'); ?>
...
<div class="container" style="max-width: 1200px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; margin-bottom: 40px;">
        <a href="<?php echo e(route('history.index', ['type' => 'all'])); ?>" 
           style="
               padding: 24px;
        ...
        <a href="<?php echo e(route('history.index', ['type' => 'projects'])); ?>" 
           style="
               padding: 24px;
        ...
        <a href="<?php echo e(route('history.index', ['type' => 'articles'])); ?>" 
           style="
               padding: 24px;
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($histories->count()): ?>
        <div style="background: white; border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); overflow: hidden;">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $histories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div style="
                    padding: 20px;
                    border-bottom: <?php echo e($loop->last ? 'none' : '1px solid #e2e8f0'); ?>;
                    display: flex;
                    gap: 20px;
                    align-items: center;
                    transition: all 0.3s;
                ...
                >
                    ...
                    <div style="flex: 1; min-width: 0;">
                        ...
                        <div style="color: #94a3b8; font-size: 13px; margin-top: 8px;">
                            🕒 <?php echo e($viewedTime->diffForHumans()); ?>

                        </div>
                    </div>
                    
                    
                    <button onclick="deleteHistory(<?php echo e($history->id); ?>)"
                            style="
                                width: 36px;
                                height: 36px;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/history/index.blade.php ENDPATH**/ ?>