        ...
        <div class="fi-ai-fetcher-panel">
            ...
            <div style="display: grid; gap: 16px;">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status): ?>
                    <div style="
                        padding: 16px;
                        background: <?php echo e(Str::contains($status, '✅') ? 'rgb(6 78 59 / 0.35)' : (Str::contains($status, '❌') ? 'rgb(127 29 29 / 0.35)' : 'rgb(30 58 138 / 0.35)')); ?>;
                        border-radius: 8px;
                        border: 1px solid <?php echo e(Str::contains($status, '✅') ? 'rgb(52 211 153 / 0.4)' : (Str::contains($status, '❌') ? 'rgb(252 165 165 / 0.4)' : 'rgb(129 140 248 / 0.4)')); ?>;
                        color: <?php echo e(Str::contains($status, '✅') ? '#6ee7b7' : (Str::contains($status, '❌') ? '#fca5a5' : '#c7d2fe')); ?>;
                        font-weight: 600;
                        margin-top: 16px;
                    ">
                        <?php echo $status; ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/filament/pages/ai-fetcher.blade.php ENDPATH**/ ?>